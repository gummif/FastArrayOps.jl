...
# 3 Arrays, scalar
macro testfunc_arr3a(func, x_exp, x0, ix, incx, y0, iy, incy, z0, iz, incz, a, n)
    quote
        func = $(esc(func))
        x_exp = $(esc(x_exp))
        x0 = $(esc(x0))
        ...
        y = copy(y0)
        z = copy(z0)
        func(x,ix,incx,y,iy,incy,z,iz,incz,a,n)
        @test_approx_eq x x_exp
        @test_approx_eq y y0
        @test_approx_eq z z0
